...
@main.route('/pytest1')
def pytest1():
    return render_template('pytest1.html', title='pytest1')

@main.route('/pytest2')
def pytest2():
    return render_template('pytest2.html', title='pytest2')

@main.route('/pytest3')
def pytest3():
    return render_template('pytest3.html', title='pytest3')

@main.route('/cpptest1')
def cpptest1():
    return render_template('cpptest1.html', title='cpptest1')
